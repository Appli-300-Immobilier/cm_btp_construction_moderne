# CM BTP -construction moderne - Plateforme Immobilière Premium

Bienvenue sur le dépôt du code source de l'application web **CM BTP -construction moderne**. Ce projet est une solution complète (Site Vitrine + Catalogue de Biens + Administration) développée avec des technologies modernes pour le secteur de l'immobilier en Cameroun.
...
**CM BTP -construction moderne**
* **Localisation :** Douala, Cameroun
* **Contact :** +237 6 56 56 79 63
* **Email :** contact@cmbtpconstructionmoderne.cm
* **Social :** [Facebook](https://www.facebook.com/profile.php?id=100072172909753) | [WhatsApp](https://wa.me/237656567963)
